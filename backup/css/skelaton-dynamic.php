...
echo ".col-sm-9 {width:". ($calc-4)*(75/100) ."px;}<br/>";
echo ".col-sm-8 {width:". ($calc-4)*(66.66666667/100) ."px;}<br/>";
echo ".col-sm-7 {width:". ($calc-4)*(58.33333333/100) ."px;}<br/>";
echo ".col-sm-6 {width:". ($calc-4)*(50/100) ."px;}<br/>";
echo ".col-sm-5 {width:". ($calc-4)*(41.66666667/100) ."px;}<br/>";
echo ".col-sm-4 {width:". ($calc-4)*(33.33333333/100) ."px;}<br/>";
echo ".col-sm-3 {width:". ($calc-4)*(25/100) ."px;}<br/>";
echo ".col-sm-2 {width:". ($calc-4)*(16.66666667/100) ."px;}<br/>";
echo ".col-sm-1 {width:". ($calc-4)*(8.33333333/100) ."px;}<br/>";
echo "}<br/><br/>";
$calc = $calc-4;
}
