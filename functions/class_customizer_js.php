<?php 
// Hesham Notes
//link_textcolor settings id only the one work here
// To add another settings and controls 
  ?>
<?php
/**
...
///////////////////////////////////////////////////////////////////////////////////
   /*  hesham settings and controls */
///////////////////////////////////////////////////////////////////////////////////   
   	  //1. section mytheme_options

      //2. Register new settings to the WP database...
      $wp_customize->add_setting( 'nav_link_textcolor', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
         array(
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
         $wp_customize, //Pass the $wp_customize object (required)
         'nav_link_textcolor', //Set a unique ID for the control
         array(
            'label' => __( 'navigation Link Color', 'mytheme' ), //Admin-visible name of the control
            ...
            'settings' => 'nav_link_textcolor', //Which setting to load and manipulate (serialized is okay)
            'priority' => 10, //Determines the order this control appears in for the specified section
         ) 
      ) );
      
      //4. We can also change built-in settings by modifying properties. For instance, let's make some stuff use live preview JS...
      $wp_customize->get_setting( 'nav_link_textcolor' )->transport = 'refresh';
      


///////////////////////////////////////////////////////////////////////////////////
   /*  END hesham settings and controls */
///////////////////////////////////////////////////////////////////////////////////   
   ...
   public static function header_output() {
      ...
      <style type="text/css">
           ...
           <?php # Hesham style added ?>
           <?php self::generate_css('p', 'color', 'nav_link_textcolor'); ?>
      </style> 
      <!--/Customizer CSS-->
      <?php
   }
