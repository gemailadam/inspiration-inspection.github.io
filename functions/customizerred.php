...
// select theme
    ...
    $wp_customize->add_section('select',array(
...
//     $wp_customize->add_setting('body_id',array('default' => '#4F0101' ));
...
// //.row color
//     $wp_customize->add_setting('row_id',array('default' => '#4F0101' ));
...
body{background-color:<?php echo get_theme_mod('body_id','#4F0101'); ?>;}
...
.row {background-color:<?php echo get_theme_mod('row_id','#4F0101'); ?>;}


/* header.css header_part_qwe*/

section.site-title a{color:<?php echo get_theme_mod('site_title_id','#000'); ?>;}
section.site-title p a:link{color:<?php echo get_theme_mod('site_title_p_a_id','#000'); ?>;}
section.site-title a:link{color: #fff;}
section.site-title a:visited{color:<?php echo get_theme_mod('site_title_visited_id','#222'); ?>;}
...
.galleryNavigationBullets a:link{background: #000;}
...
/*.nav >nav >div > ul {}
.nav >nav >div a {}
.nav> nav >div > ul > li:nth-child(n+4) {}
.nav >nav >div > ul > li:nth-child(n+4) >a {background-color:#5D030D;}     
.nav >nav >div >ul > li > ul {background-color: #5D030D;}
.nav >nav> div>ul,.nav >nav> div>ul>li >a{background-color: #5D030D;}
*/
.nav div {
    margin: 0px auto ;
    padding: 0px;
...
.nav div a {
    padding: 15px 15px; 
    background-color:<?php echo get_theme_mod('nav_a_id','#5D030D'); ?>;;
}
.nav div > ul > li {
    margin:15px 0;
    padding: 0px 0px;
    background-color:<?php echo get_theme_mod('nav_ul_li_id','#5D030D'); ?>;
    height:50px;
    float: left;
    text-shadow: 0px 7px 0 #333, 0px 6px 0 #333, 0 5px 0 #333,0 4px 0 #333, 0 3px 0 #333, 0 2px 0 #333, 0 1px 0 #333;
...
.nav div ul > li > ul {
    margin:15px 0 ;
    padding: 0px 0px;
    background-color:<?php echo get_theme_mod('nav_ul_li_ul_id','#5D030D'); ?>;
    position: absolute;
    left:-9999px;
    border-radius:5px;
    border:solid 1px #ccc;
...
div.page .rect {box-shadow:inset 4px 2px 6px #000,inset -4px 2px 6px #000;border:1px solid red;}
div.page .rect {
    margin:0 5px;
    padding: 0 20px;
    background-color:<?php echo get_theme_mod('page_id','#5D030D'); ?>;
    border-bottom:1px solid <?php echo get_theme_mod('page_border_id','#fff'); ?>;
    border-radius: 15px;
}
...
div.sidebar aside {
    margin:0 5px;
    padding: 10px 10px;
    background-color:<?php echo get_theme_mod('sidebar_id','#5D030D'); ?>;
    box-shadow: 0px 4px 8px #000;
}
div.sidebar aside {color: #fff;box-shadow:inset 4px 2px 6px #000,inset -4px 2px 6px #000;border:1px solid red;}
...
/* footer.css fopoter_part_qwe*/
section.footer1  {color: #fff;box-shadow:inset 4px 2px 6px #000,inset -4px 2px 6px #000;border:1px solid red;}
section.footer2  {color: #fff;box-shadow:inset 4px 2px 6px #000,inset -4px 2px 6px #000;border:1px solid red;}
section.footer3  {color: #fff;box-shadow:inset 4px 2px 6px #000,inset -4px 2px 6px #000;border:1px solid red;}


section.footer1 {
    margin:5px 2%;
    padding: 0px 0px;
    background-color:<?php echo get_theme_mod('footer1_id','#5D030D'); ?>;
    width:96%;
    float: left;
    /*box-shadow: 0px 4px 8px #000;*/
}
...
section.footer2 {
    margin:5px 2%;
    padding: 0px 0px;
    background-color:<?php echo get_theme_mod('footer2_id','#5D030D'); ?>;
    width:96%;
    float: left;
    /*box-shadow: 0px 4px 8px #000;*/
}
...
section.footer3 {
    margin:5px 2%;
    padding: 0px 0px;
    background-color:<?php echo get_theme_mod('footer3_id','#5D030D'); ?>;
    width:96%;
    float: left;
    /*box-shadow: 0px 4px 8px #000;*/
}
...
section.footer1  {color: #000;box-shadow:inset 4px 2px 6px #222,inset -4px 2px 6px #222;border:1px solid #0296A1;}
section.footer2  {color: #000;box-shadow:inset 4px 2px 6px #222,inset -4px 2px 6px #222;border:1px solid #0296A1;}
section.footer3  {color: #000;box-shadow:inset 4px 2px 6px #222,inset -4px 2px 6px #222;border:1px solid #0296A1;}
...
body{background-color:#fff;/*<?php echo get_theme_mod('body_id','#4F0101'); ?>;*/}
...
p{color:;/*<?php echo get_theme_mod('p_id','#000'); ?>;*/}
...
.row {
background-color:#fff;/*<?php echo get_theme_mod('row_id','#4F0101'); ?>;*/
 /*box-shadow: 2px 2px 12px #444;border: 1px solid #000;*/
 }
...
section.site-title a{color:#bbb;/*<?php echo get_theme_mod('site_title_id','#fff'); ?>;*/}
section.site-title p a:link{}
section.site-title a:link{}
section.site-title a:visited{/*<?php echo get_theme_mod('site_title_visited_id','#222'); ?>;*/}

section.site-title a {
    /*color:<?php echo get_theme_mod('site_title_id','#000'); ?>;*/
    font-size: 120%;
    text-decoration: none;
    font-weight: bold;
    padding: 0 80px;
...
section.site-title p a {
    color:#000;/*<?php echo get_theme_mod('site_title_p_a_id','#fff'); ?>;*/
    font-size: 160%;
    text-decoration: none;
    font-weight: bold;
    padding: 10px 20px;margin: 0 10px;
...
/*    box-shadow: 0px 4px 0px #000;
    -webkit-box-shadow: 0px 9px 0px #000;
        -moz-box-shadow: 0px 9px 0px #000;   
*/
}
...
@keyframes hart {
    from {border-radius: 0 60px 0 60px;}
    to {border-radius: 0 40px 40px 40px;}
}
...
.banner img {width:90%;margin:10px 5%;/*position: absolute;*/
    ...
    /*border-radius:5px;
    border:solid 1px #ccc;
    box-shadow: 0px 9px 0px  #444 , 0px 20px 25px #fff;
    -webkit-box-shadow: 0px 9px 0px #444;
        -moz-box-shadow: 0px 9px 0px #444 ;      */
/*      text-shadow: 0px 7px 0 #444, 0px 6px 0 #444, 0 5px 0 #444,0 4px 0 #444, 0 3px 0 #444, 0 2px 0 #444, 0 1px 0 #444;
*/    }
...
img#btn { width:12%;margin:10px 5%;position:absolute;left:75%;top:460px;}
img#logo {position: absolute;width:12%;margin-right:0px;margin-top: 10px;box-shadow:5px 5px 40px #fff;z-index: 10;}
...
@keyframes /*exam*/ {
    0%   {background-color: #222;border:1px solid #fff;}
    25%  {background-color: #fff;border:1px solid #222;}
    50%  {background-color: #222;border:1px solid #fff;}
    100% {background-color: #fff;border:1px solid #222;}
}
/*
@keyframes exp {
...
*/
.galleryNavigationBullets a:link{
    background: #ddd;
    box-shadow: 2px 2px 4px #fff;
    /*border:2px solid #444;*/
       /* animation-name: exp; */
...
.nav div {
    ...
    /*border-radius:5px;*/
    /*border:solid 1px #000;*/
    /*box-shadow: 0px 6px 0px #000,0px 20px 15px #111;*/
}
...
.nav div a:link ,.nav div a:visited {
    color:#fff; /*<?php echo get_theme_mod('nav_a_color_id','#000'); ?>;*/
}
.nav div a:hover {  color:#aaa;/*<?php echo get_theme_mod('nav_a_hover_id','#aaa'); ?>;*/}

.nav div a {
    padding: 15px 15px; 
    background-color:#000;/*<?php echo get_theme_mod('nav_a_id','#5D030D'); ?>;*/
}
.nav div > ul > li {
    margin:2px 1px;
    padding: 0px 0px;
    background-color:#000;/*<?php echo get_theme_mod('nav_ul_li_id','#5D030D'); ?>;*/
    height:50px;
    float: left;
    text-shadow: 0px 7px 0 #000, 0px 6px 0 #000, 0 5px 0 #000,0 4px 0 #000, 0 3px 0 #000, 0 2px 0 #000, 0 1px 0 #000;
    /*border-radius:3px 3px 5px 30px;*/
        border-radius:5px;
    border:solid 1px #000;
    box-shadow: 0px 6px 0px #fff,0px 20px 15px #222,3px 0px 5px #222,-3px 0px 5px #222;
...
.nav div > ul > li:hover {
        border-radius:5px;
    border:solid 1px #000;
    box-shadow: 0px 0px 0px #fff,0px 20px 15px #111;
...
.nav div ul > li > ul {
    margin:30px 0 ;
    padding: 0px 0px;
    background-color:#000;/*<?php echo get_theme_mod('nav_ul_li_ul_id','#5D030D'); ?>;*/
    position: absolute;
    left:-9999px;
    border-radius:5px;
    border:solid 1px #ccc;
    box-shadow: 0px 6px 0px #fff,0px 10px 15px #222;
}
.nav div > ul > li:hover > ul {left:auto;}
.nav div > ul > li > ul > li > ul {position:absolute;left:-9999px;}
...
.gallerythumContainer {
   ...
   /*box-shadow: inset 0 0 5px #ffffff , 0 9px 5px #ffffff;*/
    /*border: 1px solid #666;*/
}
...
@-webkit-keyframes expand {
    from {border-radius: 200px;}
    to {border-radius: 20px;background-color: yellow;}
}
...
.galleryThumbnil img {
   ...
   box-shadow:0 0 5px #222 , 0 9px 5px #222;
    border: 1px solid #000;
}


.galleryThumbnil img:hover {
    margin:10px 2%;
    padding: 2% 2%;
...
.gallerythumContainer input:hover {
   ...
   box-shadow:2px 2px 2px #222 ,3px 3px 5px #222;
...
div.page .rect {color: #fff;
    box-shadow:4px 2px 6px #444,-4px 2px 6px #222;border:1px solid #777;
}
div.page .rect {
    margin:0 5px;
    padding: 0 20px;
    background-color:#000;/*<?php echo get_theme_mod('page_id','#5D030D'); ?>;*/
    border-bottom:;/*<?php echo get_theme_mod('page_border_id','#000'); ?>;*/
    border-radius: 15px;
}
div.page .rect a{color: #fff;}
div.page .rect a:visited{color: #444;}

.page div.archive{font-size: 16px;padding-left: 20px;color: #000;text-shadow: 0px 6px 4px #fff;}
...
.postedby {
    margin: 10px 2%;
    padding: 0 2%;
    background-color:<?php echo get_theme_mod('postedby_id','#fff'); ?>;
    width:92%;
    box-shadow:inset 0px -1px 1px #777;
    display: inline-block;
}
...
.rect .push_button a ,.push_button a:link,.push_button a:visited {color: #fff;}
.rect .push_button{ border-top: solid 5px #fff;}
.rect .push_button a:hover {color:#444;}
...
div.sidebar aside {
    margin:0 5px;
    padding: 10px 10px;
    background-color:#000;/*<?php echo get_theme_mod('sidebar_id','#5D030D'); ?>;*/
...
section.footer1 {
    margin:5px 2%;
    padding: 0px 0px;
    background-color:#000;/*<?php echo get_theme_mod('footer1_id','#5D030D'); ?>;*/
    width:96%;
    float: left;
    color: #fff;
    box-shadow:4px 2px 6px #777,-4px 2px 6px #222;border:1px solid #777;
...
section.footer2 {
    margin:5px 2%;
    padding: 0px 0px;
    background-color:#000;/*<?php echo get_theme_mod('footer2_id','#5D030D'); ?>;*/
    width:96%;
    float: left;
    color: #fff;
    box-shadow:4px 2px 6px #777,-4px 2px 6px #222;border:1px solid #777;
...
section.footer3 {
    margin:5px 2%;
    padding: 0px 0px;
    background-color:#000;/*<?php echo get_theme_mod('footer3_id','#5D030D'); ?>;*/
    width:96%;
    float: left;
    color: #fff;
    box-shadow:4px 2px 6px #777,-4px 2px 6px #222;border:1px solid #777;
...
.oops h1 {color:#fff;box-shadow:2px 2px 4px #111;text-shadow:2px 2px 4px #111;}
...
#portfolioID {box-shadow: 2px 2px 0px #fff;border-radius: 5px;border: 2px solid #ff0033;text-align: center;color:black;}
#articlesID {box-shadow: 2px 2px 0px #fff;border-radius: 5px;border: 2px solid #ff0033;text-align: center;color:black;}
#portfolioID {
    width:60%;
    display: block;
    margin-left: auto;
...
.nav div > ul > li:nth-child(n+4) >a {
    padding: 0px 15px;
    /*background-color:#000;<?php echo get_theme_mod('nav_ul_li_id','#444'); ?>;*/
}
...
.box_shadow_qwe{box-shadow:1px 1px 12px #fff;}
.box_shadow_qwe a:hover{box-shadow:0px 0px 0px #fff,0px 0px 0px #fff;}
