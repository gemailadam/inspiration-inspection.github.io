...
body {
    background-color:<?php echo get_theme_mod('Background_COLOR_Settings_ID',''); ?>;
    background-image:<?php echo "url('"; ?> <?php echo get_theme_mod('Background_Img_Settings_ID','.//images/bg.jpg');?>
   <?php echo "');"; ?>  

}
.row {
    background-image:<?php echo "url('"; ?> <?php echo get_theme_mod('Background_Img_Settings_ID','circ.png');?>
   <?php echo "');"; ?>  
