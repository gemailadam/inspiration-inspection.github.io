...
.galleryNavigationBullets a:link{background: #ddd;box-shadow: 2px 2px 4px #fff;border:2px solid #444;}
...
.gallerythumContainer input:hover {
   ...
   box-shadow:inset 2px 2px 2px #fff ,inset 3px 3px 5px #222;
...
div.page .rect {color: #fff;box-shadow:inset 4px 2px 6px #222,inset -4px 2px 6px #222;border:1px solid #000;}
div.page .rect {
    margin:0 5px;
    padding: 0 20px;
...
section.footer1 {
    ...
    float: left;
    color: #fff;
    box-shadow:inset 4px 2px 6px #222,inset -4px 2px 6px #222;border:1px solid #fff;
    border:1px solid #000;
    /*box-shadow: 0px 4px 8px #fff;*/
}
