...
function wwwp_add_menu (){
  ...
  <style>
    ...
    .bg a{margin: 10px;padding:0 10px ;border:2px solid #fff;}
...
function css_abo7lawa(){

echo '<style type="text/css">';
echo 'html {color:black;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;}';
echo '.site-title p a {color:blue;}';
echo 'a:link {color:green;}';
echo 'a:visited {color:yellow;}';
